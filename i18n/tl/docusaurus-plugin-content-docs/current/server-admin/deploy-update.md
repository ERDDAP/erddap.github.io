...
## Ibaba{#download} 
3. Ibaba [erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.30.0/ERDDAP-2.30.0.war) sa _tomcat_/webapps .
     (bersyon 2.30.0, 706,939,121 bytes, MD5=CDC4B3D82A20B33A6623B85312F6DC21, na may petsang 2026-04-06) 
     
## mensahe.xml{#messagesxml} 
4. 
    * Karaniwan: Kung ikaw ay lumalayo ERDDAP™ bersyon 1.46 (o sa itaas) at gagamitin mo lamang ang pamantayang mga mensahe, ang bagong pamantayang mga mensahe. (kabilang ang mga talaksang .class sa pamamagitan ng erddap. digmaan) .
         
...
WEB-INF/class/gov/noa/pfel/erddap/util/messages.xml pagkatapos ng erddap.war ay decompressed sa pamamagitan ng Tomcat).
         
    * Pambihira: Kung ikaw ay mag - iingat ng isang mensahe ng kaugalian. _tomcat_/content/erddap /,
...
4. Kopyahin ang bagong erddap. talaksang pandigma mula sa pansamantalang directory hanggang _tomcat_/webapps
...
6. Pangmalas ERDDAP™ sa inyong browser upang tiyakin na ang natitirang bahagi ay nagtagumpay.
     (Kadalasan, kailangan mong subukan nang ilang beses at maghintay ng isang minuto bago mo makita ERDDAP™ .)   
             
### Windows{#windows} 
1. Shutdown Tomcat: Mula sa command line, gamitin: __Tomcat_\bin\\ shutdown.bat 
2. Alisin ang decompressed ERDDAP™ pagluklok: Sa _tomcat_/webapps, gamitin
del /S/Q erddap
...
Mga Suliraning Nagdudulot ng Paglubha ERDDAP ? Tingnan ang [sa pagkuha ng karagdagang suporta](/docs/intro#support) .
