...
# Paghahanap at Pagtatanghal ng mga Video ERDDAP™ 

Ipinakikita ng dokumentong ito kung paano itatanghal ang mga video sa ERDDAP™ , gayundin ang
Nakalilikha ng dataset na nagbibigay sa paghahanap ng video metadata
ang mga video na nakatutugon sa napiling batayan sa paghahanap.

Ang mahahalagang bahagi na kailangan upang itatag ito ay una, mga video na
ay nasa isang format na maaaring ipakita sa isang web browser ( ERDDAP™ mismo
ay hindi nagtatanghal ng video, ito'y nagbibigay lamang ng kawing), at pangalawa, ng csv
talaksan (o isang katulad na mesang nakabase sa format gaya ng parquet) naglalaman ng
Ang metadata ay may kaugnayan sa mga video.

Ang pagkakaroon ng angkop na format ng video ay mahalaga. Sa halimbawa sa ibaba
Ang mga video ay orihinal na isang lumang format ng Windowides na kahit ang mga Windows browser
ay hindi makapagtanghal mula sa kahon, at kailangang magdagdag ng plagin. Matanda Na
Ang mga format ay kadalasang napakalaking files. Ang aplikasyong Handbrake ay maaaring maging
ang mga video, na siyang ginawa.

## Paglalagay

Ang unang hakbang ay ang paglikha ng isang “EDDTable FromFileNames” dataset upang maging
may isang URL na nauugnay sa bawat video na madaling makuha
ang ERDDAP™ “file “. Samantalang isang halimbawa ng dataset na ito ay ibinibigay
sa ibaba, ang pinakamabuting paraan upang gawin ang xml na ito para sa iyong mga video ay gamitin
Mga GenerateDataset Xml.sh at itinuro sa directory gamit ang mga video (sa loob ng
pangkalahatan ang pinakamabuting paraan upang magdagdag ng mga bagong datasets ERDDAP™ ay gamitin
Mga GenerateDataset Xml.sh na magdadala sa iyo sa karamihan ng daan doon, at
saka isaayos iyan para sa pangwakas na resulta).

Ang ikalawang hakbang ay lumikha ng EDDTable FromAsciiFiles (o kahawig) 
dataset na naglalaman ng metadata na gagamitin sa video
paghahanap. Isang halimbawa ang ibinibigay sa ibaba. Upang magawa ito ay kailangang may isa nito
na naglalaman ng kawing sa video, halimbawa ito ang video
Iba't ibang “videoFile”. Ang variable na ito ay maaari lamang maglaman ng buong URL
Nalikha sa unang hakbang, subalit pagkatapos ang talaksan ay hindi nabibitbit, gaya ng kung ano ang
nais mong subukin ang isang makina at pagkatapos ay aktuwal na magsilbi sa ibang makina
makina.

Maaari mong gawing portable ang file sa pamamagitan ng paggawa sa entry sa “videoFile”
ang relatibong landas patungo sa video, sa halimbawa sa ibaba ng isa sa gayong landas ay:

2010_Piggy_Bank_audio_hipped/0001_20100627_144631.mp431.

Pagkatapos ay maaari mong idagdag ang “AccessBaseUrl” na siyang dahilan kung bakit
URL sa landas sa kolum. Halimbawa:

```
<att name="fileAccessBaseUrl"><https://coastwatch.pfeg.noaa.gov/erddap/files/fed_HAGE_VisualSurvey/></att>
```

Kung gayon kung ikaw ay magpapalit ng mga server kailangan mo lamang baguhin ang isang katangiang iyon
ang xml snippet, hindi mo na kailangang i - edit ang csv file.

Kapag nagawa na, mayroon kang listahan ng mga video na magagamit bilang mga file:
...
isang payak na paghahanap na itinatag ng “EDDTable FromFileNames” dataset:
...
Ang default opsyon sa huling URL ay gumagawa ng URL:

 [ https://coastwatch.pfeg.noaa.gov/erddap/tabledap/fed_HAGE_VisualSurvey_Query.htmlTable?time,CommonName,latitude,longitude,depth,videoFile&time%3E%3D2022-09-06&CommonName=“black " rockfishison "](https://coastwatch.pfeg.noaa.gov/erddap/tabledap/fed_HAGE_VisualSurvey_Query.htmlTable?time%2CCommonName%2Clatitude%2Clongitude%2Cdepth%2CvideoFile%26time%3C%3D2022-09-06%26CommonName%3D%E2%80%9Cblack%20rockfish%E2%80%9D) 

At gumagawa ng dulang na may huling kolum:
...
Ang bawat isa sa mga kalahok sa tugon ay naglalaan ng kawing sa isang video, gaya ng
kung bubugunin mo ang una mong nakuha:
...
at kung i - click mo ito sa html Talaan ng mga video display
browser.
