...
2.30.0, tingnan ang [Pagbabago ng dokumentasyon](/changes#version-2300) at [download ito](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) .
...
Ang mga grocked at tabular science dataset sa mga karaniwang file format at gumawa ng mga graph at mapa.
 ERDDAP™ ay Isang Malaya at Bukás na Pinagmumulan (Apache at Apache-tulad)   Java Alis NOAA   NMFS   SWFSC Paghahati sa Pananaliksik sa Kapaligiran ( ERD ) .

* Upang makita/gamit ang isang ERDDAP™ pagluklok: [ https://coastwatch.pfeg.noaa.gov/erddap/index.html ](https://coastwatch.pfeg.noaa.gov/erddap/index.html) 
* Upang magsimula sa isang instalasyon na binasa [ng install guide](/docs/server-admin/deploy-install) .
* Upang makapag - abuloy ng kodigo tingnan ang [gabay ng programmer](/docs/contributing/programmer-guide) .


Makikita mo sa ibaba ang kaugnay na mga kaugnayan sa pagtatanong at kung paano mag - aabuloy.
* Repasuhin ang mga usapan at magtanong sa [ https://groups.google.com/g/erddap ](https://groups.google.com/g/erddap) o sa [ https://github.com/erddap/erddap/discussions ](https://github.com/erddap/erddap/discussions) 
* Magrepaso at magpadala ng mga isyu [ https://github.com/erddap/erddap/issues ](https://github.com/erddap/erddap/issues) 
* Upang makapagmungkahi ng mga kahilingan, sundin ang patnubay na ito: [ ERDDAP Talakayin #93 (komento) ](https://github.com/ERDDAP/erddap/discussions/93#discussion-4920427) 


## Maraming Paghahanap ERDDAP™ s
May dalawang paraan upang saliksikin ang multiple ERDDAP™ mga datos: [Maraming Paghahanap ERDDAP™ s](/SearchMultipleERDDAPs.html) at [ ERDDAP™ Talaan ng mga Nilalaman](http://erddap.com/) .


## Itatag ang Iyong Sarili ERDDAP™  {#set-up-your-own-erddap} 

 ERDDAP™ ay isang [Malaya at Bukás na Pinagmumulan](https://en.wikipedia.org/wiki/Free_and_open-source_software) , all- Java   (servet) , web application na tumatakbo sa isang web application server (Halimbawa, si Tomcat (mungkahi) , o Jetty (mabisa ito, subalit hindi namin sinusuportahan ito) ) . Ang pahinang web na ito ay karamihang para sa mga tao (" ERDDAP™ Mga administrador") na nagnanais magtatag ng sarili nilang ERDDAP™ naka-install sa kanilang sariling website.
...
maaari kang magtatag ERDDAP™ upang makuha ang iyong impormasyon sa pamamagitan ng umiiral na serbisyo.
...
* Minsang magkaroon ka nito ERDDAP™ nagsilbi sa iyong data, wakasan ang mga gumagamit nito:
    * Hilingin ang impormasyon sa iba't ibang paraan ( DAP , WMS , at higit pa sa hinaharap) .
...
*    [LANGIS ERDDAP™ ](https://canwinerddap.ad.umanitoba.ca/erddap/index.html)   (Ang Canadan Watershed Information Network) sa Centre for Earth Observation Science (MGA CEO) , Unibersidad ng Manitoba
*    [KONIP](https://erddap.cdip.ucsd.edu/erddap/index.html)   (Programa sa Impormasyon ng Coastal Data sa UCSD)  
...
*    [High School Technology Services](https://myhsts.org) , na nag-aalok ng coding at teknolohiya pagsasanay para sa mga mag-aaral at adulto
...
LMI ECLERS (Pinaghalo ang Laboratoire sa Buong Daigdig «Etude du Climat en Afrique de l’Ouest et de ses Interactions vec l’Environnement Régional, et appui aux serbisyo climatiques») 
...
* NCI (Ang Pambansang Konstitusyonal na Infrastructure ng Australia) 
...
*    [ NOAA IOOS GCOS A Octronic and Oceanographic Data: Observing System](https://erddap.gcoos.org/erddap/index.html)   
     ...
     [ NOAA IOOS GCOOS Biological and Socio Economics](https://gcoos4.tamu.edu/erddap/index.html)   (Sistema ng Pagmamasid sa Karagatan ng Gulpo) 
...
*    [ NOAA IOOS NG NGDAC](https://data.ioos.us/gliders/erddap/index.html)   (Pambansang Glider Sentro ng Kapulungan ng mga Data)  
*    NOAA MGA IOO NANOO (Northern Association of Networked Ocean Observing Systems) 
*    [ NOAA MGA PROO NG IOOO](https://pae-paha.pacioos.hawaii.edu/erddap/index.html)   (Sistema ng Obserbasyon sa Karagatang Pasipiko) sa University of Hawaii (UH)  
...
*    NOAA SSTP NG NGGDC (Pambansang Heopisikal Sentro ng mga Data, Solar -- Terrestrial Physics) 
*    NOAA   NMFS NEFSC (Northeast Fisheries Science Center) 
*    [ NOAA MGA BO-OP](https://opendap.co-ops.nos.noaa.gov/erddap/index.html)   (Sentro ng mga Produksyonal na Panitikan at Serbisyo)  
*    [ NOAA OSMC](http://osmc.noaa.gov/erddap/index.html)   (Pagmamasid sa System Monitoring Center)  
...
*    [Matalinong Atlantiko](https://www.smartatlantic.ca/erddap/index.html) Memorial University ng Newfoundland
...
*    [BATA](https://erddap.observations.voiceoftheocean.org/erddap/index.html)   (Tinig ng Karagatan, Sweden)  
...
###  ERDDAP™ ay inirerekomenda sa loob NOAA at mga CNR{#erddap-is-recommended-within-noaa-and-cnrs} 
 [ NOAA 'S Data Access Procedual Directive](https://www.ngdc.noaa.gov/wiki/index.php/Data_Access_Technical_Recommendations#Software_implementations) kasama ang ERDDAP™ sa listahan nito ng inirerekomendang mga server ng impormasyon na gagamitin ng mga grupo sa loob NOAA . ERDDAP™ ay may pagsang - ayong binabanggit sa seksiyon 4.2.3 ng
...
## Mga Pagtatanghal ng Likaw{#slide-shows} 
...
Maaari mo ring gawin [panoorin ang video na ito ni Bob na nagpapahayag![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=H541G1XXZrU&t=4) .
...
*    [2018 ESIP SA Tag - araw: Suporta ng JON ERDDAP™ ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/SimonsErddapJson2018.pptx) 
*    [2018 EDM: Sistema ng Pamamahagi ng mga Web Services (Mas Mabilis, Mas Madali, Mas Kaunti ang Halaga)   (O, kung bakit ako maligaya 4 na taon na ang nakalipas.) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/10P.04_Simons_DistributedWebServices2018.pptx) 
...
*    [2017 EDM: Paano napupunta ang datos mula sa pinagmulan patungo sa gumagamit ng dulo? Lumang Paaralan Laban sa Bagong Paaralan](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/OldSchoolNewSchool.pptx) 
...
Mga Paraan ng Ibang Tao:

*    [ISANG matibay na batayang kasangkapan upang mapasulong ang pamamahagi ng Global Data![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=kdBTgNEp5TA&ab_channel=GOOSIOC)   
...
*    [Pagtatayo ng Iyong Sariling Lagay ng Panahon NOAA Open Data at mga Tampok na Aklat![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=MF-WH01Qw0g)   
ni Filipe Fernandes at Rich Signell sa SciPy 2018, Hulyo 13, 2018.
*    [Paggamit ng OOI ERDDAP ![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=tj4M9hodTG0)   
by Rich Signell, Pebrero 2018.
*    [ESIP Tech Dive: " ERDDAP Nag-uusap ang Kidlat"![" YouTube "](/img/youtube.png)](https://youtu.be/2-ydBByYB0M?t=160)   
Walong 5-Munong Pag-uusap Tungkol sa Kawili-wiling mga Bagay na Ginagawa ng mga Tao ERDDAP nina Jenn Sevadjian, Jim Potemra, Conor Delaney, Kevin O'Brien, John Kerfoot, Stephanie Petrillo, Charles Carleton at Eli Hunter na itinanghal bilang isang ESIP Tech Dive noong Agosto 31, 2017.
*    [Paggamit ERDDAP™ Upang Makakuha ng Tablar Data![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=_BwMHRh7CS8)   
Sa pamamagitan ng Rich Signell, Agosto 2015.
*    [Pagsubok sa Paggamit ERDDAP™ para sa Blue Carbon Data![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=TbOhElC_-qU)   
Sa pamamagitan ng Rich Signell, Agosto 2015.
*    [Paggamit ng Data Mula sa ERDDAP™ sa loob NOAA ' GNOME Software![" YouTube "](/img/youtube.png)](https://www.youtube.com/watch?v=18xZoXu1USM) .
Sa video na ito, ini - download ng Rich Signell ang mga agos ng karagatan na humuhula ng impormasyon mula sa mga impormasyon ERDDAP™ upang imodelo ang isang nakalalasong natapong langis sa karagatan [ NOAA ' GNOME software](https://response.restoration.noaa.gov/oil-and-chemical-spills/oil-spills/response-tools/gnome.html)   (sa loob ng 5 minuto&#33;) . (Isang maliit na pagkakamali sa video: kapag naghahanap ng datasets, huwag gumamit ng AT sa pagitan ng mga termino sa paghahanap. Ito'y maliwanag.) Sa Pamamagitan ng Mayamang Signell, Abril 8, 2011.
