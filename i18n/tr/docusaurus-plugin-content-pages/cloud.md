...
Evet.
 ...
 ERDDAP™ Yerel veya bulut ortamlarında koşabilen Tomcat içinde koşmak için tasarlanmıştır. Resmi Docker görüntüsü mevcuttur [Docker Hub](https://hub.docker.com/r/erddap/erddap) . The The The The The The The The `erddap:alpha-latest` etiketi en son değişikliklere dayanan bir yapıdır (Bir ‘ gece serbest bırakılması gibi bir şey, [alfa-latest ayrıntıları](https://hub.docker.com/layers/erddap/erddap/alpha-latest/) ) Ancak, `erddap:` En son test edilen sürüm ( [Son ayrıntıları](https://hub.docker.com/layers/erddap/erddap/latest/) ) . Ayrıca GitHub konteyner kayıt defteri sürümlerini atabilirsiniz [GitHub Paketleri](https://github.com/ERDDAP/erddap/pkgs/container/erddap) . Kullanımı hakkında daha fazla okuyabilirsiniz ERDDAP™ ile birlikte [Docker](https://github.com/ERDDAP/erddap/blob/main/DOCKER.md) .

Kubernetes dağıtımları için, yeni dağıtım-kubernetes [Belge belgeleri](https://erddap.github.io/docs/server-admin/admin-tips/deploy-kubernetes) .
