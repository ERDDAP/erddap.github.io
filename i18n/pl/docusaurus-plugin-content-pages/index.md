...
2.30.0, patrz [zmienia dokumentację](/changes#version-2300) oraz [Pobierz go](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) .
...
taktowane i tabelaryczne zbiory danych naukowych we wspólnych formatach plików oraz wykresy i mapy.
 ERDDAP™ jest wolnym i otwartym źródłem (Apache i Apache- like)   Java Służebnica NOAA   NMFS   SWFSC Dział Badań nad Środowiskiem ( ERD ) .
...
* Aby dodać kod zobacz [Przewodnik programisty](/docs/contributing/programmer-guide) .
...
* Raz ERDDAP™ obsługa danych, użytkownicy końcowi mogą:
    ...
    * Zrób wykresy i mapy. (Każdy lubi ładne zdjęcia.) 
...
Możesz. [Dostosuj](/docs/server-admin/deploy-install#customize) na ERDDAP Wygląd tak ERDDAP™ odzwierciedla swoją organizację i pasuje do reszty witryny.
...
Albo, możesz dołączyć do [ ERDDAP™ Grupa Google / Lista dyskusyjna](https://groups.google.com/g/erddap) i wyślij tam swoje pytanie.

## Kto używa ERDDAP™  {#who-uses-erddap} 

 ERDDAP™ została zainstalowana przez około 100 organizacji w co najmniej 17 krajach
...
*    [GoMRI](https://erddap.griidc.org/erddap/index.html)   (Inicjatywa badawcza Zatoki Meksykańskiej)  
...
*    [I NCO IS](https://erddap.incois.gov.in/erddap/index.html)   (Indyjskie Narodowe Centrum Informacji Oceanowej)  
* TRZECIE (Institut de Recherche pour le Développement, Francja)   
...
* NCI (Australijska krajowa infrastruktura komputerowa) 
...
*    [ NOAA IOOS GCOOS Atmosfera i dane oceanograficzne: system obserwacji](https://erddap.gcoos.org/erddap/index.html)   
     ...
     [ NOAA IOOS GCOOS Biological and Socjoeconomics](https://gcoos4.tamu.edu/erddap/index.html)   (System obserwacji oceanów przybrzeżnych Zatoki Perskiej) 
...
*    NOAA NGDC STP (National Geophysical Centrum danych, Solar -- Fizyka lądowa) 
*    NOAA   NMFS NEFSC (Centrum Naukowe ds. Rybołówstwa Północno-Wschodniego) 
*    [ NOAA NOS CO- OPS](https://opendap.co-ops.nos.noaa.gov/erddap/index.html)   (Centrum Operacyjnych Produktów Oceanograficznych i Usług)  
...
* Instytut Estuary San Francisco
...
To jest lista tylko niektórych organizacji, gdzie ERDDAP™ został zainstalowany przez jakąś osobę lub grupę. Nie oznacza to, że osoba fizyczna, grupa lub organizacja zaleca lub popiera ERDDAP .

###  ERDDAP™ jest zalecane w NOAA i CNRS{#erddap-is-recommended-within-noaa-and-cnrs} 
 [ NOAA Dyrektywa proceduralna dotycząca dostępu do danych](https://www.ngdc.noaa.gov/wiki/index.php/Data_Access_Technical_Recommendations#Software_implementations) obejmuje ERDDAP™ w wykazie zalecanych serwerów danych do wykorzystania przez grupy w ramach NOAA . ERDDAP™ jest dobrze wymienione w sekcji 4.2.3
[Guide de bonnes pratiques sur la gestion des données de la recherche
 (Zarządzanie danymi badawczymi Przewodnik dotyczący najlepszych praktyk) ] ( https://mi-gt-donnees.pages.math.unistra.fr/guide/04-traiter.html#deposer-et-structurer-dans-des-plateformes-de-gestion-de-donnees-locales ) Centrum Narodowe de la Recherche Scientifique (CNRS) we Francji.

## Pokazy slajdów{#slide-shows} 

Oto kilka pokazów slajdów PowerPoint i dokumentów, które Bob Simons stworzył związane z ERDDAP .
...
Można również [Obejrzyj ten film z Bobem, który wygłasza tę rozmowę![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=H541G1XXZrU&t=4) .
*    [Jedna strona Opis ERDDAP™   (.pdf) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ERDDAP_OnePage.pdf) 
...
*    [2020- 05- 19 DMIT: Zakup danych](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ErddapDataIngest.pptx)   (Lub [Obejrzyj ten film z Bobem, który wygłasza tę rozmowę](https://www.youtube.com/watch?v=9ArYxgwON2k) .) 
...
*    [2018 EDM: dystrybuowany system usług internetowych (Szybszy, łatwiejszy, mniej kosztowny)   (Albo dlaczego byłem szczęśliwy 4 lata temu.) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/10P.04_Simons_DistributedWebServices2018.pptx) 
...
*    [2018 EDM: UAF i ERDDAP™ Rozwiązania integracji danych](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/3D3_Simons_DataIntegration2018.pptx) 
...
*    [2016 Summer ESIP: The Big Picture: PARR, OPeNDAP , ERDDAP™ oraz dystrybucja danych](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TheBigPicture.pptx) 
...
Kevina O 'Briena z Globalnego Systemu Obserwacji Oceanu (GOOS) Webinar / Grupa Koordynacyjna ds. Obserwacji (OCG) Seria / 1, 12 listopada 2020.
...
*    [Stosowanie ERDDAP™ dostępu do danych tabelarycznych![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=_BwMHRh7CS8)   
by Rich Signell, August 2015.
*    [Korzystanie z testu ERDDAP™ dla danych dotyczących niebieskiego węgla![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=TbOhElC_-qU)   
by Rich Signell, August 2015.
...
W tym filmie Rich Signell pobiera dane prognozujące prądy oceaniczne ERDDAP™ modelować toksyczny wyciek do oceanu używając [ NOAA jest GNOME oprogramowanie](https://response.restoration.noaa.gov/oil-and-chemical-spills/oil-spills/response-tools/gnome.html)   (Za 5 minut&#33;) . (Jeden mały błąd w filmie: podczas wyszukiwania zbiorów danych nie używaj AND pomiędzy terminami wyszukiwania. Jest dorozumiany.) Przez Rich Signell, 8 kwietnia 2011.
