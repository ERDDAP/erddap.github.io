...
2.30,0, zie [de documentatie wijzigen](/changes#version-2300) en [download het](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) .
...
* Om bij te dragen code zie de [programmeursgids](/docs/contributing/programmer-guide) .
...
Omdat de kleine poging om ERDDAP™ brengt vele voordelen.

* Als u al een webservice hebt voor het verspreiden van uw gegevens,
...
* Voor elke dataset hoef je alleen een klein stukje XML te schrijven om te zeggen ERDDAP™ hoe toegang te krijgen tot de dataset.
* Zodra u ERDDAP™ het dienen van uw gegevens, kunnen eindgebruikers:
    * De gegevens op verschillende manieren aanvragen ( DAP , WMS , en meer in de toekomst) .
    * Get the data response in diverse bestandsformaten. (Dat is waarschijnlijk de grootste reden&#33;) 
    * Maak grafieken en kaarten. (Iedereen houdt van mooie foto's.) 
    * Bouw andere nuttige en interessante dingen bovenop ERDDAP 's Web services -- zie de [ Awesome ERDDAP TM](https://github.com/IrishMarineInstitute/awesome-erddap) lijst van geweldig ERDDAP - gerelateerde projecten.

U kunt [aanpassen](/docs/server-admin/deploy-install#customize) uw ERDDAP Het lijkt erop dat ERDDAP™ weerspiegelt uw organisatie en past in de rest van uw website.

## Is de installatieprocedure moeilijk? Mag ik het doen?{#is-the-installation-procedure-hard-can-i-do-it} 

De eerste installatie duurt enige tijd, maar het is niet erg moeilijk. Je kunt het. Als je vastzit, mail me dan op erd dot data at noaa dot gov . Ik zal je helpen.
...
*    [CanWIN ERDDAP™ ](https://canwinerddap.ad.umanitoba.ca/erddap/index.html)   (Canadian Watershed Information Network) bij het Centrum voor Aardobservatiewetenschap (CEOS) , Universiteit van Manitoba
...
*    [EMODnet Natuurkunde](https://erddap.emodnet-physics.eu/erddap/index.html)   (Het Europees marien observatie- en datanetwerk - Natuurkunde)  
...
*    [High School Technology Services](https://myhsts.org) , die programmeren en technologie training biedt voor studenten en volwassenen
...
UPMC (Université Pierre et Marie CURIE, Paris, Frankrijk)   
UCAD (Universiteit Cheikh Anta Diop de Dakar, Sénégal)   
UGB (Université Gaston Berger -- Saint-Louis du Sénégal)   
UFHB (Universiteit Félix HOUPHOUËT-BOIGNY, Abidjan, Ivoorkust)   
...
*    [ NOAA IOOS GCOOS Atmosferische en Oceanografische gegevens: Observatiesysteem](https://erddap.gcoos.org/erddap/index.html)   
...
*    NOAA IOOS SCCOOS (Observatiesysteem voor de kust van Californië) 
...
*    NOAA NGDC STP (Nationaal Geofysisch Datacenter, Zonne -- Terrestrische Fysica) 
...
*    [ NOAA OSMC](http://osmc.noaa.gov/erddap/index.html)   (Monitoringcentrum voor het observeren van systemen)  
...
* Princeton, Onderzoeksgroep Hydrometeorologie
...
Dit is een lijst van enkele organisaties waar ERDDAP™ is geïnstalleerd door een individu of een groep. Het betekent niet dat het individu, de groep, of de organisatie adviseert of onderschrijft ERDDAP .
 ...
 **DISCLAIMER: De inhoud en meningen in deze documenten zijn de persoonlijke mening van Bob Simons en geven niet noodzakelijkerwijs een standpunt van de regering of de National Oceanic and Atmospheric Administration .** 
...
*    [ ERDDAP : Zware belasting, rasters, Clusters, Federaties, en Cloud Computing](/docs/server-admin/scaling) 
*    [Richtsnoeren van Bob voor datadistributiesystemen](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/erdData.html) 
...
*    [2018 Zomer ESEP: Subsetting In ERDDAP™ ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/SimonsErddapSubset2018.pptx) 
...
*    [2018 EDM: UAF en ERDDAP™ Oplossingen voor gegevensintegratie](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/3D3_Simons_DataIntegration2018.pptx) 
...
*    [2015 Summer ESEP: Tabulaire samentrekking](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TabularAggregation.pptx) 
...
*    [2014 Zomer-ESIP: Tabulaire gegevens](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TabularData.pptx) 
...
door Kevin O'Brien bij het Global Ocean Observing System (GOOS) Coördinatiegroep Webinar / Observatie (OCG) Serie / 1, november 12, 2020.
