físeán agus tacar sonraí
================================================================================================================================================================================================================================================================
2026-05-27

# Ag cuardach le haghaidh agus a thaispeáint Físeáin i ERDDAP™ 

Taispeánann an doiciméad seo conas físeáin a thaispeáint i ERDDAP™ , chomh maith le
a chruthú tacar sonraí a dhéanann foráil chun cuardach a dhéanamh ar na meiteashonraí físeáin
teacht ar na físeáin a chomhlíonann na critéir chuardaigh roghnaithe.

Is iad na comhpháirteanna riachtanacha is gá a chur ar bun ar dtús, físeáin go
i bhformáid is féidir a thaispeáint i bhrabhsálaí gréasáin ( ERDDAP™ féin
Ní léiríonn an físeán, soláthraíonn sé ach nasc), agus an dara, csv
comhad comhad (nó formáid tábla den chineál céanna bunaithe ar nós parquet) go bhfuil an
meiteashonraí a bhaineann leis na físeáin.

Tá formáid físeán cuí eochair. Sa sampla thíos an
físeáin a bhí ar dtús d'aois Fuinneog formáid go fiú brabhsálaithe Windows
Ní fhéadfaí a thaispeáint as an mbosca, agus ag teastáil ag cur breiseán. Sean agus óg
formáidí go minic comhaid an-mhór. Is féidir leis an iarratas handbrake a bheith
a úsáidtear a thiontú ar na físeáin, a bhfuil an méid a rinneadh.

## Socraigh suas

Is é an chéad chéim a chruthú "EDDTableFromFileNames" tacar sonraí ionas go
tá URL a bhaineann le gach físeán atá inrochtana trí
an ERDDAP™ "comhaid" ordú. Cé go dtugtar sampla den tacar sonraí seo
thíos, is é an bealach is fearr a ghiniúint seo xml do físeáin a úsáid
Sonraí a ghiniúint Xml.sh agus é a chur in iúl don eolaire leis na físeáin (i
ginearálta an bealach is fearr chun tacair shonraí nua a chur leis ERDDAP™ Is é a úsáid
Sonraí a ghiniúint Xml.sh a gheobhaidh tú an chuid is mó ar an mbealach ann, agus
ansin in eagar go don toradh deiridh).

Is é an dara céim ná EDDTableFromAsciiFiles a chruthú (nó a leithéid) 
tacar sonraí go bhfuil na meiteashonraí atá le húsáid sa físeán
cuardach. Tugtar sampla thíos. Chun seo a bheith ag obair ní mór go mbeadh ceann
colún go bhfuil nasc leis an físeán, sa sampla is é an
athróg "físeán". Is féidir an athróg go bhfuil ach an URL iomlán
a cruthaíodh sa chéad chéim, ach ansin nach bhfuil an comhad iniompartha, amhail is dá mba
ba mhaith leat a thástáil ar mheaisín amháin agus ansin a sheirbheáil i ndáiríre ar a chéile
meaisín.

Is féidir leat a dhéanamh ar an comhad iniompartha ag déanamh an iontráil i "físeán" a bheith
an cosán coibhneasta ar an físeán, sa sampla thíos amháin den sórt sin cosán:

Tuilleadh roghanna...

Ansin, is féidir leat a chur ar an "fileAccessBaseUrl" tréith a ghabhann leis sin
URL chun an cosán sa cholún. Sa sampla:

```
<att name="fileAccessBaseUrl"><https://coastwatch.pfeg.noaa.gov/erddap/files/fed_HAGE_VisualSurvey/></att>
```

Ansin, má tá tú freastalaithe athrú is gá duit ach a athrú go tréith amháin i
an snippet xml, ní gá duit a chur in eagar ar an comhad csv.

Nuair a rinneadh, tá tú liosta de na físeáin inrochtana mar chomhaid:
...
cuardach simplí arna bhunú ag an tacar sonraí “EDDTableFromFileNames”:
...
agus an cuardach meiteashonraí ag:
...
Na roghanna réamhshocraithe sa URL deireanach a thabhairt ar aird ar an URL:

 [ https://coastwatch.pfeg.noaa.gov/erddap/tabledap/fed_HAGE_VisualSurvey_Query.htmlTable?time,CommonName,latitude,longitude,depth,videoFile&time%3E%3D2022-09-06&CommonName=“black iasc carraig "](https://coastwatch.pfeg.noaa.gov/erddap/tabledap/fed_HAGE_VisualSurvey_Query.htmlTable?time%2CCommonName%2Clatitude%2Clongitude%2Cdepth%2CvideoFile%26time%3C%3D2022-09-06%26CommonName%3D%E2%80%9Cblack%20rockfish%E2%80%9D) 

agus a tháirgeann tábla leis an gcolún deireanach:
...
Soláthraíonn gach ceann de na hiontrálacha sa fhreagra nasc chuig físeán, mar shampla
má tá tú ag luch thar an chéad cheann a fhaigheann tú:
...
agus má chliceálann tú air sa html Tábla na taispeántais físeán i do
bhrabhsálaí.
