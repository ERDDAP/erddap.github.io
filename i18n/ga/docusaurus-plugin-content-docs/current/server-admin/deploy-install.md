...
4. Ar Linux, Mac, agus Windows, íoslódáil[erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.28.0/erddap.war)isteach _ síos / iarratais.
...
Is é an comhad .war mór toisc go bhfuil sé chósta réiteach ard, teorainn, agus sonraí ingearchló is gá chun léarscáileanna a chruthú.
    ...
    [2.27.0](https://github.com/ERDDAP/erddap/releases/download/v2.27.0/erddap.war)  (620,554,403 beart, dátaithe Inis dúinn, le do thoil...) 
    \\]
