...
1. Déan na hathruithe atá liostaithe i [Amharc ar gach eolas](/changes) sa roinn dar teideal "Things ERDDAP™ Riarthóirí An riachtanas is gá a fhios agus a dhéanamh" do gach ceann de na ERDDAP™ leaganacha ó na leagan a bhí tú ag baint úsáide as.
     
##  Java  {#java} 
...
1. Toradh síos Tomcat: Ó líne ordú, a úsáid: _tomcat_/bin / shutdown.sh
...
5. Atosaigh Tomcat agus ERDDAP : úsáid a bhaint as _cat_/bin/startup.sh
...
1. Toradh síos Tomcat: Ó líne ordú, úsáid: _tomcat_\\bin\\ shutdown.bat 
2. Bain an decompressed ERDDAP™ a shuiteáil: I _tomcat_/webapps, úsáid
Seirbhís do Chustaiméirí
