...
2.30.0, féach ar an [data recovery](/changes#version-2300) agus [íoslódáil](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) .
...
gridded agus tacair shonraí eolaíochta tabular i bhformáidí comhad coitianta agus graif agus léarscáileanna a dhéanamh.
...
* A fheiceáil / a úsáid ERDDAP™ a shuiteáil: [ https://coastwatch.pfeg.noaa.gov/erddap/index.html ](https://coastwatch.pfeg.noaa.gov/erddap/index.html) 
...
is féidir leat a chur ar bun ERDDAP™ rochtain a fháil ar do shonraí tríd an tseirbhís atá ann cheana.
Nó, Is féidir leat a bhunú ERDDAP™ chun rochtain a fháil ar do chuid sonraí go díreach ó chomhaid áitiúla.
* I gcás gach tacar sonraí, ní mór duit ach a scríobh smután beag de XML a insint ERDDAP™ conas teacht ar an tacar sonraí.
* Nuair a bheidh tú ERDDAP™ ag freastal ar do chuid sonraí, is féidir le húsáideoirí deiridh:
    ...
    * Tógáil rudaí úsáideacha agus suimiúil eile ar bharr ERDDAP 's seirbhísí gréasáin - féach ar an [ Awesome ERDDAP TM](https://github.com/IrishMarineInstitute/awesome-erddap) liosta de uamhnach ERDDAP tionscadail a bhaineann leo.

Is féidir leat [customize](/docs/server-admin/deploy-install#customize) do do chuid féin ERDDAP 's cuma mar sin ERDDAP™ Léiríonn do eagraíocht agus luíonn i leis an gcuid eile de do láithreán gréasáin.
...
## Cé a Úsáidí ERDDAP™  {#who-uses-erddap} 

 ERDDAP™ suiteáilte ag thart ar 100 eagraíochtaí i dtíortha 17 ar a laghad

 (An Astráil, an Bheilg, Ceanada, an tSín, an Fhrainc, an India, Éire, an Iodáil, an Nua-Shéalainn, an Rúis, an Afraic Theas, an Spáinn, Srí Lanca, an tSualainn, an Téalainn, an Ríocht Aontaithe, SAM) , lena n-áirítear:
...
* CSIRO agus IMOS (Comhlathas na hAstráile Eagraíocht Taighde Eolaíochta agus Tionscail agus an Córas Breathnóireachta Muirí Comhtháite) 
...
*    [Is maith liom é NCO IS FÉIDIR](https://erddap.incois.gov.in/erddap/index.html)   (Ionad Náisiúnta na hIndia do Sheirbhísí Faisnéise Aigéan)  
...
UFHB (Ollscoil na hÉireann, Gaillimh An bhfuil cuntas agat? Logáil isteach)   
...
* NPP (Bonneagar Ríomhaireacht Náisiúnta na hAstráile) 
...
*    [ NOAA IOOS Ce NCO OSPS](https://erddap.axiomdatascience.com/erddap/index.html)   (Lár agus Tuaisceart California Ocean Observing Córas, reáchtáil ag Axiom Eolaíocht Sonraí)  
...
*    NOAA IOOS NANOOS (Iarthuaisceart Cumann Córais Breathnú Aigéan Líonraithe) 
...
*    [ NOAA Féach ar Léarscáileanna](http://osmc.noaa.gov/erddap/index.html)   (Breathnú Ionad Monatóireachta Córas)  
 ...
 **DISCLAIMER: Is iad tuairimí pearsanta Bob Simons an t-ábhar agus na tuairimí a léirítear sna doiciméid seo agus ní gá go léireodh siad aon phost de chuid an Rialtais nó an National Oceanic and Atmospheric Administration .** 
...
*    [A One Page Tuairisc ar ERDDAP™   (Clár na dToghthóirí) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ERDDAP_OnePage.pdf) 
...
*    [Roghnaigh gach rud Samhraidh SIEP: Sonraí Tabular](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TabularData.pptx) 
...
ag Kevin O'Brien ag an gCóras Domhanda Aigéan Breathnú (Déan Teagmháil Linn) Grúpa Comhordaithe Gréasáin / Breathnóireachta (Amharc ar gach eolas) Sraith / 1, Samhain 12, 2020.
...
Ocht 5-Minute Caint Maidir Suimiúil Daoine Rudaí An bhfuil Doing Le ERDDAP ag Jenn Sevadjian, Jim Potemra, Conor Delaney, Kevin O'Brien, John Kerfoot, Stephanie Petillo, Charles Carleton agus Eli Hunter curtha i láthair mar tumadóireachtP Teicneoir Teicneoir ar 31 Lúnasa, 2017.
