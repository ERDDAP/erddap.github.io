...
Vi vil prøve å finne feil før større distribusjon av byggverket.
...
* Som bruker=tomcat:
  * I \\[ tomcat \\] /bin/ :
./shutdown.sh //use "ps -fu tomcat" for å sikre at det har stoppet
  * I \\[ tomcat \\] /webapps/ :
rm-rf erddap
rm erddap. krig
