...
2.30.0, se [endringer i dokumentasjon](/changes#version-2300) og [Last ned den](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) ..
...
gitte og tabellære vitenskapelige datasett i felles filformater og lage grafer og kart.
 ERDDAP™ En fri og åpen kilde (Apache og Apache-lignende)   Java Servlet fra NOAA   NMFS   SWFSC Miljøforskningsavdelingen ( ERD ) ..

* å se/bruke en ERDDAP™ installasjon: [ https://coastwatch.pfeg.noaa.gov/erddap/index.html ](https://coastwatch.pfeg.noaa.gov/erddap/index.html) 
* Å komme i gang med en installasjon les [utplasseringsinstallasjonsguiden](/docs/server-admin/deploy-install) ..
* For å bidra til koden se [Programmørens guide](/docs/contributing/programmer-guide) ..


Nedenfor finner du relevante lenker for å stille spørsmål og hvordan du skal bidra.
* Se gjennom samtaler og stille spørsmål på [ https://groups.google.com/g/erddap ](https://groups.google.com/g/erddap) eller på [ https://github.com/erddap/erddap/discussions ](https://github.com/erddap/erddap/discussions) 
...
## Søk Flere ERDDAP™ s
Det finnes to måter å søke på flere ERDDAP™ s for datasett: [Søk Flere ERDDAP™ s](/SearchMultipleERDDAPs.html) og [ ERDDAP™ Datasett Discovery](http://erddap.com/) ..


## Sett opp din egen ERDDAP™  {#set-up-your-own-erddap} 

 ERDDAP™ er en [Fri og åpen kilde](https://en.wikipedia.org/wiki/Free_and_open-source_software) Alt- Java   (Servlet) , webprogram som kjører i en webapplikasjonsserver (For eksempel Tomcat (Anbefalt) , eller Jetty (Fungerer, men vi støtter det ikke) ) .. Denne siden er mest for folk (" ERDDAP™ administratorer) som ønsker å sette opp sin egen ERDDAP™ installasjon på egen hjemmeside.

Å komme i gang med en installasjon les [utplasseringsinstallasjonsguiden](/docs/server-admin/deploy-install) ..

### Hvorfor bruke ERDDAP™ å distribuere dine data?{#why-use-erddap-to-distribute-your-data} 
...
* Når du har ERDDAP™ serverer dine data, kan sluttbrukere:
    * Be om dataene på ulike måter ( DAP , WMS Mer og mer i fremtiden) ..
...
Du kan [tilpasse](/docs/server-admin/deploy-install#customize) din ERDDAP utseendet så ERDDAP™ reflekterer organisasjonen og passer inn i resten av nettsiden din.

## Er installasjonsprosessen vanskelig? Kan jeg gjøre det?{#is-the-installation-procedure-hard-can-i-do-it} 

Den første installasjon tar litt tid, men det er ikke så vanskelig. Du kan gjøre det. Hvis du sitter fast, send meg e-post til erd dot data at noaa dot gov .. Jeg hjelper deg.
Eller du kan bli med i [ ERDDAP™ Google Group/E-postliste](https://groups.google.com/g/erddap) og legger spørsmålet der.

## Hvem som bruker ERDDAP™  {#who-uses-erddap} 

 ERDDAP™ er installert av ca. 100 organisasjoner i minst 17 land
...
*    [BCO-DMO hos WHOI](https://erddap.bco-dmo.org/erddap/index.html)   (Biologisk og kjemisk oseanografi Datahåndteringskontor på Woods Hole Oceanografisk Institusjon)  
...
*    [CDIP](https://erddap.cdip.ucsd.edu/erddap/index.html)   (Informasjon om kystdata på UCSD)  
...
*    [Hakai Institutt](https://catalogue.hakai.org/erddap/index.html)   (Hakai Institute on the Central Coast of British Columbia, Canada) 
*    [High School Technology Services](https://myhsts.org) , som tilbyr kode- og teknologitrening for studenter og voksne
*    [ICHEC](https://erddap.ichec.ie/erddap/index.html)   (Irsk senter for høyend computing) 
*    [Jeg NCO IS](https://erddap.incois.gov.in/erddap/index.html)   (Indian National Centre for Ocean Information Services)  
* IRD (Institut de Recherche power le Développement, Frankrike)   
CNRS (Bestillinger Bla gjennom Centre National de la Recherche Scientificique)   
UPMC (Université Pierre et Marie CURIE, Paris, Frankrike)   
UCAD (Université Cheikh Anta Diop de Dakar, Sénégal)   
UGB (Université Gaston Berger - Saint-Louis du Sénégal)   
UFHB (Université Félix Hotell i Abidjan, Elfenbenskysten)   
IPSL (Institutt Pierre Simon Laplace des Sciences de l'environnement, Paris, Frankrike)   
LMI ECLAIRS (Laboratoire Mixte International «Etude du Climat en Afrique de l’Ouest et de ses Interaksjoner avec l'Environnement Régional, et appui aux-tjenester klimatiques») 
* JRC (Europakommisjonen - Felles forskningssenter, EU) 
*    [Marineinstituttet](https://erddap.marine.ie/erddap/index.html)   (Irland)  
* Marine Instruments S.A. (Spania) 
* NCI (Australias nasjonale utbyggingsinfrastruktur) 
...
*    [ NOAA IOOS Ce NCO OS](https://erddap.axiomdatascience.com/erddap/index.html)   (Det sentrale og nordlige California Ocean Observation System, drevet av Axiom Data Science)  
*    [ NOAA IOOS GCOOS Atmosfæriske og oseanografiske data: Observasjonssystem](https://erddap.gcoos.org/erddap/index.html)   
     ...
     [ NOAA IOOS GCOOS Biologisk og Socioøkonomisk](https://gcoos4.tamu.edu/erddap/index.html)   (Gulf Coast Ocean Observation System) 
*    [ NOAA IOOS NERACOOS](http://www.neracoos.org/erddap/index.html)   (Nordøstlige regionale forening av kyst- og havobservasjonssystemer)  
*    [ NOAA IOOS NGDAC](https://data.ioos.us/gliders/erddap/index.html)   (National Glider Datasamlingssenter)  
*    NOAA IOOS NANOOS (Nordvestforening av nettverkede havobservasjonssystemer) 
*    [ NOAA IOOS PacIOOS](https://pae-paha.pacioos.hawaii.edu/erddap/index.html)   (Stillehavsøyene) ved University of Hawaii (UH)  
*    NOAA IOOS SCCOOS (Sørlige California Coastal Ocean Observation System) 
*    [ NOAA IOOS Secoora](https://erddap.secoora.org/erddap/index.html)   (Sørøstlige kysthavet observasjon regionale forening)  
*    [ NOAA NCEI](https://www.ncei.noaa.gov/erddap/index.html)   (Nasjonale sentre for miljøinformasjon)    
*    NOAA NGDC STP (National Geofysisk Datasenter, solcelle -- terrestrisk fysikk) 
...
*    [ NOAA UAF](https://upwell.pfeg.noaa.gov/erddap/index.html)   (Samlede tilgangsrammer)  
...
OOI/Ukabele data
* Princeton, Hydrometeorologi Forskningsgruppe
...
*    [Scripps Institusjon av Oceanografi, Spray Undervannsglidere](https://spraydata.ucsd.edu/erddap/index.html)  
*    [Smart Atlantic](https://www.smartatlantic.ca/erddap/index.html) Minnehøyskolen i Newfoundland
* Sørafrikansk miljøobservasjonsnettverk
* Spyglassteknologi
* Stanford University, Hopkins Marine Station
*    [UNESCO IODE](https://erddap.oa.iode.org/erddap/index.html)   (Internasjonal oseanografisk og informasjon Datautveksling)  
*    [University of British Columbia, Earth, Ocean & Atmosfære vitenskapsavdeling](https://salishsea.eos.ubc.ca/erddap/index.html)  
*    [University of California ved Davis Bodega Marine Laboratorium](http://bmlsc.ucdavis.edu:8080/erddap/index.html)  
*    [Universitetet i Delaware, Satellittmottak stasjon](https://basin.ceoe.udel.edu/erddap/index.html)  
...
Dette er en liste over bare noen av organisasjonene der ERDDAP™ har blitt installert av noen individer eller en gruppe. Det betyr ikke at individet, gruppen eller organisasjonen anbefaler eller støtter ERDDAP ..

###  ERDDAP™ anbefales innen NOAA CNRS{#erddap-is-recommended-within-noaa-and-cnrs} 
...
## Lysbildeshow{#slide-shows} 

Her er noen PowerPoint lysbildeshow og dokumenter som Bob Simons har opprettet relatert til ERDDAP ..

 **innhold og meninger som uttrykkes i disse dokumentene, er Bob Simons personlige meninger og reflekterer ikke nødvendigvis regjeringens eller National Oceanic and Atmospheric Administration ..** 
...
*    [ ERDDAP : Tunge laster, gitter, klynger, føderasjoner, og Cloud Computing](/docs/server-admin/scaling) 
...
*    [2018 Sommer ESIP: Undersetting ERDDAP™ ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/SimonsErddapSubset2018.pptx) 
*    [2018 Sommer ESIP: JSON Støtte i ERDDAP™ ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/SimonsErddapJson2018.pptx) 
*    [2018 EDM: Et distribuert system av webtjenester (Raskere, lettere, billigere)   (Hvorfor var jeg lykkelig for 4 år siden?) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/10P.04_Simons_DistributedWebServices2018.pptx) 
...
*    [2017 EDM: En rask introduksjon til ERDDAP ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ErddapIntro.pptx) 
...
*    [2017 EDM: Hvordan kommer data fra kilden til sluttbrukeren? Gammel skole mot ny skole](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/OldSchoolNewSchool.pptx) 
*    [2016 Sommer ESIP: Den store bilden: PARR, OPeNDAP , ERDDAP™ og datadistribusjon](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TheBigPicture.pptx) 
...
*    [2013: Ikke behandl In-Situ og Tabular Data som gitt data](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TablesAndGrids.html) 
*    [2013 EDM: Gjør mer med mindre](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/DoMoreWithLess.ppt) 
...
Kevin O'Brien i det globale observasjonssystemet i havet (GOOS) Webinar / Observasjon Koordinasjon Gruppe (OCG) Serien / 1, 12. november 2020.
*    [Bygg din egen værapp ved hjelp av NOAA Åpne data og jupyternotebøker![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=MF-WH01Qw0g)   
