...
2.30.0 ดู [เปลี่ยนเอกสาร](/changes#version-2300) และ [ดาวน์โหลดมัน](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) .

##  ERDDAP™ ข้อมูล{#erddap-information} 

 ERDDAP™ เป็นเซิร์ฟเวอร์ข้อมูลทางวิทยาศาสตร์ ที่ทําให้ผู้ใช้สามารถดาวน์โหลดสับเซตได้ง่ายขึ้น และสอดคล้องกัน
ข้อมูลทางวิทยาศาสตร์ที่ฝังอยู่ในแฟ้มรูปแบบเดียวกัน และทํากราฟและแผนที่
 ERDDAP™ เป็น แหล่ง ที่ มี อิสระ และ เปิด เผย (อาปาเช่ กับ อาปาเช่)   Java รับ ใช้ จาก NOAA   NMFS   SWFSC แผนกวิจัยสิ่งแวดล้อม ( ERD ) .
...
* เพื่อสนับสนุนรหัส ดู [คู่มือโปรแกรมโปรแกรม](/docs/contributing/programmer-guide) .


ข้าง ล่าง นี้ คุณ จะ พบ จุด เชื่อม ที่ เกี่ยว ข้อง กัน สําหรับ การ ถาม และ วิธี บริจาค.
...
* โปรด ทํา ตาม คํา แนะ นํา ต่อ ไป นี้: [ ERDDAP การสนทนา # 93 (หมายเหตุ) ](https://github.com/ERDDAP/erddap/discussions/93#discussion-4920427) 


## ค้นหาหลายรายการ ERDDAP™ วินาที
มีสองวิธีที่จะค้นหาหลาย ๆ ERDDAP™ s สําหรับชุดข้อมูล: [ค้นหาหลายรายการ ERDDAP™ วินาที](/SearchMultipleERDDAPs.html) และ [ ERDDAP™ ค้นพบชุดข้อมูล](http://erddap.com/) .


## ตั้งตัวของคุณเอง ERDDAP™  {#set-up-your-own-erddap} 

 ERDDAP™ คือ [เปิดและเปิดแหล่ง](https://en.wikipedia.org/wiki/Free_and_open-source_software) ทั้งหมด... Java   (เซรุ่มName) แม่ข่ายบริการเว็บ (ยกตัวอย่างเช่น ทอมแคท (แนะนํา) หรือ เจ็ตตี้ (มันได้ผล แต่เราไม่ได้สนับสนุนมัน) ) . หน้าเว็บนี้ส่วนใหญ่เหมาะกับคน (" ERDDAP™ ผู้ดูแลระบบ") ที่ต้องการตั้งตัวเอง ERDDAP™ ติดตั้งที่เว็บไซต์ของพวกเขาเอง

เพื่อเริ่มอ่านการติดตั้ง [คู่มือการติดตั้งที่ใช้งาน](/docs/server-admin/deploy-install) .

### ทําไมใช้ ERDDAP™ เพื่อกระจายข้อมูลของคุณ?{#why-use-erddap-to-distribute-your-data} 

เพราะความพยายามเล็กน้อยที่จะตั้งขึ้น ERDDAP™ นํา มา ซึ่ง ผล ประโยชน์ มาก มาย.
...
หรือ คุณสามารถตั้ง ERDDAP™ เพื่อเข้าถึงข้อมูลของคุณโดยตรงจากแฟ้มภายในระบบ
* สําหรับข้อมูลแต่ละชุด, คุณเพียงแค่เขียนส่วนย่อยของ XML เพื่อบอกว่า ERDDAP™ วิธีการเข้าถึงชุดข้อมูล
* เมื่อคุณมี ERDDAP™ ส่งข้อมูลของคุณ ผู้ใช้ปลายทางสามารถ:
    * ร้องขอข้อมูลในรูปแบบต่าง ๆ ( DAP . WMS และอีกในอนาคต) .
    * รับส่งข้อมูลในรูปแบบแฟ้มต่าง ๆ (นั่นน่าจะเป็นเหตุผลที่ใหญ่ที่สุด) 
    * ทํากราฟและแผนที่ (ทุกคนชอบรูปสวยๆทั้งนั้น) 
    * สร้างสิ่งอื่น ๆ ที่มีประโยชน์และสิ่งที่น่าสนใจบน ERDDAP บริการเว็บ ดู [ Awesome ERDDAP ขนาด TM](https://github.com/IrishMarineInstitute/awesome-erddap) รายการของสุดยอด ERDDAP - โครงการที่เกี่ยวข้อง
...
## ขั้นตอนการติดตั้งเป็นเรื่องยาก? ทําได้มั้ย?{#is-the-installation-procedure-hard-can-i-do-it} 
...
*    [BCODO ที่ WHOI](https://erddap.bco-dmo.org/erddap/index.html)   (ชีวภาพ และ ธรณี วิทยา สํานักงาน การ จัด การ ข้อมูล ที่ ศูนย์ มหา สมุทร ไม้ ตั้งค่า)  
...
*    [DIVER ( NOAA ผิดพลาด) ](https://pub-data.diver.orr.noaa.gov/erddap/index.html)   ( NOAA สํานักงาน บรรเทา ทุกข์ และ ซ่อมแซม)  
...
*    [ภาษาโกมีรีName](https://erddap.griidc.org/erddap/index.html)   (เขต งาน วิจัย อ่าว เม็กซิโก)  
...
CNRS (ศูนย์ แห่ง ชาติ เด ลา เร เชอ ร์)   
UPMC (ยูนิเวอร์เต ปิแอร์ เอต มารี Curie, ปารีส, ฝรั่งเศส)   
แบบ UCAD (ยู นิ เวอร์ ส เต เชก อัน ตา ดิ โอ ป เด ดาการ์ เซ เนกัล)   
ขนาด UGB (Universesite Motton Berger -- Saint-lois du Seneagal)   
ขนาด UFHB (ยู นิ เวอร์ ซิ ตี ฟี ลิกซ์ HUFFOLULT-BOGEY, Abiddjan, Cuff'Doice)   
ISL (Pierre Pierre Simon Laplas Des De'invronment, ปารีส ฝรั่งเศส)   
LMI ECLARS (อินเตอร์เนชันแนล « สืบค้นเมื่อ 7 พฤษภาคม พ.ศ.) 
* อาร์ก (คณะ กรรมาธิการ ยุโรป - ศูนย์ วิจัย ร่วม, สหภาพ ยุโรป) 
*    [สถาบัน ทะเล](https://erddap.marine.ie/erddap/index.html)   (ไอร์แลนด์)  
* นาวิกโยธิน พ.ศ. (สเปน) 
* NCI (กรมควบคุมแห่งชาติของออสเตรเลีย) 
...
*    [ NOAA Name=กล้องดูดาวโคสต์Name](https://coastwatch.glerl.noaa.gov/erddap/index.html)   (ทะเลสาบ ใหญ่)  
*    [ NOAA ชายฝั่ง](https://coastwatch.pfeg.noaa.gov/erddap/index.html) ซึ่งรวมเข้ากับและทํางานกับ
     [ NOAA   ERD ](https://coastwatch.pfeg.noaa.gov/erddap/index.html)   (หน่วยงานวิจัยสิ่งแวดล้อมของ SWFSC ของ NMFS ) 
...
*    [ NOAA IOOS GCOS Atmosporic และข้อมูลทางทะเล: ระบบสังเกต](https://erddap.gcoos.org/erddap/index.html)   
     [ NOAA ข้อมูล ทาง ธรณี วิทยา และ มหาสมุทร: คลัง ข้อมูล ทาง ประวัติศาสตร์](https://gcoos5.geos.tamu.edu/erddap/index.html)   
     [ NOAA ไอโอโอเอส ชีวเคมีและเศรษฐกิจสังคม](https://gcoos4.tamu.edu/erddap/index.html)   (ระบบสังเกตทะเลอ่าว) 
...
*    [ NOAA ไอโอออส](https://pae-paha.pacioos.hawaii.edu/erddap/index.html)   (หมู่เกาะแปซิฟิก) ที่ มหาวิทยาลัย ฮาวาย (เอ่อ)  
*    NOAA IOOSCOS (แคลิฟอร์เนียตอนใต้) 
*    [ NOAA ไอโอออส กัสโซเรีย](https://erddap.secoora.org/erddap/index.html)   (สมาคม ท้อง ถิ่น แถบ ชายฝั่ง ตะวัน ออก เฉียง ใต้)  
*    [ NOAA เซมิ](https://www.ncei.noaa.gov/erddap/index.html)   (ศูนย์ ข้อมูล สิ่ง แวด ล้อม แห่ง ชาติ)    
*    NOAA STP แบบ NGDC (ธรณี วิทยา แห่ง ชาติ ศูนย์ข้อมูล สุริยุปราคา - เทอร์เรสไดเรกซ์) 
...
*    [เครือข่ายติดตามมหาสมุทร](https://members.oceantrack.org/erddap/index.html)  
...
* อุปกรณ์ สเปกตรัม
* มหาวิทยาลัยสแตนฟอร์ด สถานีนาวิกโยธินฮอปกินส์
*    [UNESCO IODE](https://erddap.oa.iode.org/erddap/index.html)   (ฐานข้อมูลมหาสมุทรระหว่างประเทศ สลับข้อมูล)  
...
###  ERDDAP™ ขอแนะนําให้อยู่ภายใน NOAA และ CNRS{#erddap-is-recommended-within-noaa-and-cnrs} 
 [ NOAA การเข้าถึงข้อมูลแบบตายตัว](https://www.ngdc.noaa.gov/wiki/index.php/Data_Access_Technical_Recommendations#Software_implementations) รวม ERDDAP™ ในรายการของเซิร์ฟเวอร์ข้อมูลที่ขอแนะนําให้ใช้โดยกลุ่มต่าง ๆ ภายใน NOAA . ERDDAP™ มี การ กล่าว ถึง อย่าง เหมาะ สม ใน ตอน 4.2.3 ของ
[Guide de Bonnes Pratiques sur la gression des Donnes de la Recherches
...
นี่คือภาพสไลด์ PowerPoint และเอกสารที่บ็อบ ไซมอนสร้าง ERDDAP .

 **DECLIMER: เนื้อหาและความคิดเห็นที่แสดงในเอกสารเหล่านี้เป็นความคิดเห็นส่วนบุคคลของบ๊อบไซมอนและไม่จําเป็นต้องสะท้อนสถานะของรัฐบาลใด ๆ หรือ National Oceanic and Atmospheric Administration .** 
...
*    [คําบรรยายหน้าเดียวของ ERDDAP™   (.pdf) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ERDDAP_OnePage.pdf) 
*    [ ERDDAP สืบค้นเมื่อ 20 พฤษภาคม พ.ศ.](/docs/server-admin/scaling) 
*    [เส้นนําสําหรับระบบกระจายข้อมูลของบ็อบ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/erdData.html) 

การนําเสนออื่น ๆ:

*    [2020 EDM: คุณสมบัติใหม่ใน พ.ศ. ERDDAP™ v2. 10](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ErddapFeatures2.10.pptx) 
...
*    [2018 ESIP ฤดู ร้อน: Json รองรับใน ERDDAP™ ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/SimonsErddapJson2018.pptx) 
*    [2018 EDM: ระบบบริการเว็บที่ถูกแบ่งแยก (เร็วขึ้น, ง่ายขึ้น, ราคาน้อย)   (หรือทําไมผมมีความสุขเมื่อ 4 ปีก่อน) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/10P.04_Simons_DistributedWebServices2018.pptx) 
*    [2018 EDM: ค.ศ. ERDDAP™ ใน ปี 2018](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/7A4_Simons_ErddapSession2018.pptx) 
...
*    [2018 EDM: UAF และ พ.ศ. ERDDAP™ วิธี แก้ไข ความ รู้](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/3D3_Simons_DataIntegration2018.pptx) 
*    [2017 EDM: แนะนําอย่างรวดเร็ว ERDDAP ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ErddapIntro.pptx) 
*    [2017 EDM และ 2017 IOOS: New หรือ Little know ERDDAP™ คุณสมบัติ (สําหรับผู้ใช้) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ErddapUserFeatures2017.pptx) 
*    [2017 EDM และ 2017 IOOS: New หรือ Little know ERDDAP™ คุณสมบัติ (สําหรับผู้ดูแลระบบ) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ErddapAdminFeatures2017.pptx) 
*    [2017 EDM: EML, KNB, และ ERDDAP ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/eml_knb_erddap.pptx) 
*    [2017 อีดีเอ็ม: ข้อมูลได้รับจากแหล่งไปยังผู้ใช้สุดท้ายได้อย่างไร? โรงเรียนเก่ากับโรงเรียนใหม่](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/OldSchoolNewSchool.pptx) 
...
*    [2016 Gov API: รุ่นถัดไป เซิร์ฟเวอร์ข้อมูล](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/NextGeneration.pptx) 
*    [2015 ESIP ในฤดูร้อน: Tabular a February](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TabularAggregation.pptx) 
*    [2014 EDM: Bob's Dos and don't for Tabular Dative](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/SimonsDosDontsTabular.pptx) 
*    [2014 EDM: ส่วนติดต่อผู้ใช้แบบ ISTIME](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TheIdealUserInterface.pptx) 
*    [2014 ESIP ฤดู ร้อน: ข้อมูล ตาบ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TabularData.pptx) 
*    [2013: อย่าทํากับ In-Situ และ Tabular Dtata like Gried ข้อมูล](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TablesAndGrids.html) 
*    [2013 EDIM: ทํามากขึ้นกับน้อย](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/DoMoreWithLess.ppt) 
*    [2012 EDM: กํากับระบบกระจายข้อมูล พ.ศ.](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/guidelines3.ppt) 
...
โดย เควิน โอ'ไบรอัน ที่ศูนย์สํารวจมหาสมุทรโลก (โกส) กรุ๊ปรวมการควบรวมกิจการ (OCG) September / 1, November 12, 2020.
...
โดย Filpipe Ferandes and Rich Signell ที่ SciPy 2018, 13 กรกฎาคม 2018.
*    [ใช้ โอ อี ERDDAP ![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=tj4M9hodTG0)   
2018 โดย ริช ซินญอล 2018.
*    [ESIP เทคไดฟ: ERDDAP ฟ้าผ่าพูด![YouTube](/img/youtube.png)](https://youtu.be/2-ydBByYB0M?t=160)   
การสนทนาเกี่ยวกับสิ่งที่น่าสนใจที่ผู้คนกําลังทํา ERDDAP โดย Jen Sevadjian, จิม potemra, คอเนอร์ เดลานี, เควิน โอ'ไบอัน, จอห์น เคอร์ฟุต, สเตฟานี เพ็ตโล, ชาร์ลส์ คาร์ลตัน และอีไล ฮันเตอร์ นําเสนอเป็น ESIP Tech Dieve เมื่อวันที่ 31 สิงหาคม 2017.
...
*    [การ ทดสอบ ERDDAP™ สําหรับข้อมูลคาร์บอนสีน้ําเงิน![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=TbOhElC_-qU)   
2015 โดย ริช ซินญอล (Rich Signell) พ.ศ.
*    [ใช้ข้อมูลจาก ERDDAP™ ใน NOAA ' GNOME ซอฟต์แวร์![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=18xZoXu1USM) .
ในวิดีโอนี้ ริชเซ็นเซลล์ดาวน์โหลดข้อมูลพยากรณ์ของมหาสมุทร ERDDAP™ เพื่อจําลองการรั่วไหลของสารพิษในมหาสมุทร [ NOAA ' GNOME โปรแกรม](https://response.restoration.noaa.gov/oil-and-chemical-spills/oil-spills/response-tools/gnome.html)   (อีก 5 นาที) . (ความผิดพลาดเล็ก ๆ ในวิดีโอคือ เมื่อค้นหาชุดข้อมูล ไม่ใช้และอยู่ระหว่างคําค้น มันอยู่โดยนัย) 8 เมษายน 2011.
