...
สร้างใหม่ใน ERDDAP™ รุ่น 2.29.0 ด้วย EDDGrid จาก NCFiles มีการทดลองรองรับตัวแปรข้อมูลที่ไม่สนับสนุนตัวแปรแกนทั้งหมด (หรืออย่างที่บางคนเรียกมันว่า 1D และ 2D ในชุดข้อมูลชุดเดียวกัน) .
...
*    [ **แก้ไขโครงการหลัก...** ](#eddtable) ชุดข้อมูลจัดการข้อมูลรอบนอก
    ...
    * ประเภทข้อมูล EDTable คือ:
        ...
        *    [DDTable from Mqt](/docs/server-admin/mqtt-integration) ที่อยู่ติดต่อใหม่... หมายเหตุเอกสารอยู่ในหน้าอุทิศ สังเกตว่ามีความคล้ายคลึงกันมาก [เพิ่มข้อมูล](#eddtablefromhttpget) .
...
*    [ **_เวลาหน่วงการ** ](#legacy_time_adjust) เริ่มใน ERDDAP™ 2.29.0 ตัวแปรเวลาทํางานแตกต่างกันเล็กน้อย ในกรณีหายาก ส่วนใหญ่เมื่อใช้ `วันตั้งแต่` และหนึ่งปีก่อนปี 1582 (ดังนั้น `วันตั้งแต่ 0000-01-01` หรือ `วันตั้งแต่ 1-1.00:00:0.00` ) คุณจะต้องระบุสําหรับการปรับปรุงตัวแปรวันที่ เหตุผลก็คือ ERDDAP™ ใช้ห้องสมุดเวลาจาวา จัดการวันที่ภายใน มีชุดข้อมูลบางอย่างที่ต้องการใช้ไลบรารีเกรกอเรียนคาเลนดาร์เก่า เพื่อแก้ไขวันที่ที่ถูกต้อง
