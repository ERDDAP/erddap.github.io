...
# ค้นหาและแสดงวิดีโอใน ERDDAP™ 

เอกสารนี้แสดงวิธีแสดงวิดีโอใน ERDDAP™ เช่นเดียวกัน
สร้างชุดข้อมูลที่จะใช้ค้นหาข้อมูลกํากับภาพ
ค้นหาวิดีโอที่ตรงกับเกณฑ์การค้นหาที่เลือก

องค์ประกอบที่จําเป็นในการตั้งเจ้านี่ก่อน, วิดีโอที่
อยู่ในรูปแบบที่สามารถแสดงผลในเว็บเบราว์เซอร์ได้ ( ERDDAP™ ตัวมันเอง
ไม่ได้แสดงวิดีโอ, มันให้การเชื่อมโยงเท่านั้น), และอย่างที่สอง, Csv
แฟ้ม (หรือรูปแบบตารางที่คล้ายกันเช่น parquet) ที่บรรจุ
ข้อมูลกํากับที่เกี่ยวข้องกับวิดีโอ

การมีรูปแบบวิดีโอที่เหมาะสมเป็นกุญแจสําคัญ ในตัวอย่างด้านล่าง
วิดีโอ แต่ เดิม เป็น รูป แบบ หน้าต่าง แบบ เก่า ๆ ที่ แม้ แต่ นก นาง นวล
ไม่สามารถแสดงออกจากกล่องได้ และต้องการเพิ่มส่วนเสริม เก่า
ฟอร์แมตมักจะเป็นแฟ้มขนาดใหญ่มาก โปรแกรมวาดมือสามารถ
ใช้แปลงวิดีโอ, ซึ่งก็คือสิ่งที่ทําไปแล้ว

## ตั้งค่า

ขั้นแรกคือการสร้างข้อมูล “Edtable from files"
มีที่อยู่ URL ที่เกี่ยวกับวิดีโอแต่ละตัวที่สามารถใช้ได้
คือ ERDDAP™ "แฟ้ม" คําสั่ง ในขณะที่ตัวอย่างชุดข้อมูลชุดนี้
ด้านล่างนี้, วิธีที่ดีที่สุดในการสร้าง xml สําหรับวิดีโอคือใช้
ตั้งค่าชุดภาพไอคอนสื่ออารมณ์ Xml.sh และชี้ไปยังไดเรกทอรีที่มีวิดีโอ (in
วิธีที่ดีที่สุดในการเพิ่มชุดข้อมูลใหม่ ERDDAP™ จะใช้
ตั้งค่าชุดภาพไอคอนสื่ออารมณ์ Xml.sh ซึ่งจะทําให้คุณได้เกือบถึงตรงนั้น, และ
จากนั้นแก้ไขผลสุดท้าย

ขั้นที่สองคือสร้างแฟ้ม ADTA จาก Ascii (หรือคล้ายกัน) 
ชุดข้อมูลที่มีข้อมูลกํากับภาพที่จะใช้ในวิดีโอ
ค้นหา ตัว อย่าง หนึ่ง ให้ ไว้ ข้าง ล่าง นี้. เพื่อให้ได้ผล ต้องมีใครสักคน
คอลัมน์ที่มีลิงก์ไปยังวิดีโอ, ในตัวอย่าง
ตัวแปร "วีดิโอเฟซ". ตัวแปรนี้สามารถบรรจุที่อยู่ URL เต็มได้
สร้างขึ้นในขั้นตอนแรก แต่แล้วไฟล์ไม่ได้พกพาเช่นถ้า
คุณต้องทดสอบเครื่องจักรหนึ่ง แล้วให้บริการอีกเครื่องหนึ่ง
เครื่องจักร

คุณสามารถทําแฟ้มแบบพกพาได้โดยให้รายการใน "หมายเลขแฟ้ม" เป็น
เส้นทางสัมพัทธ์ของวิดีโอ ในตัวอย่างใต้เส้นทางหนึ่งคือ

2010_Piggy_Bank_audiad_sport/0001_20100627_144631.mp4

จากนั้นคุณสามารถเพิ่มคุณสมบัติ "fileccessBaseUrl" ที่เพิ่มเติม
ที่อยู่ URL ไปยังพาธในคอลัมน์ ในตัวอย่างนี้:

```
<att name="fileAccessBaseUrl"><https://coastwatch.pfeg.noaa.gov/erddap/files/fed_HAGE_VisualSurvey/></att>
```

แล้วถ้าคุณเปลี่ยนเซิร์ฟเวอร์ คุณต้องเปลี่ยนคุณลักษณะนั้น
ชิ้นส่วน xml, คุณไม่จําเป็นต้องแก้ไขแฟ้ม csv

เมื่อเสร็จแล้ว คุณมีรายการของวิดีโอที่เข้าถึงได้เป็นแฟ้ม:
...
การค้นหาแบบเรียบง่ายที่ถูกตั้งค่าขึ้นโดยชุดข้อมูล “DDTable from Files"
...
ตัวเลือกปริยายในที่อยู่ URL ล่าสุด จะก่อให้เกิดที่อยู่ URL:

 [ https://coastwatch.pfeg.noaa.gov/erddap/tabledap/fed_HAGE_VisualSurvey_Query.htmlTable?time,CommonName,latitude,longitude,depth,videoFile&time%3E%3D2022-09-06&CommonName=“black ปลาร็อค](https://coastwatch.pfeg.noaa.gov/erddap/tabledap/fed_HAGE_VisualSurvey_Query.htmlTable?time%2CCommonName%2Clatitude%2Clongitude%2Cdepth%2CvideoFile%26time%3C%3D2022-09-06%26CommonName%3D%E2%80%9Cblack%20rockfish%E2%80%9D) 

และมันได้ผลิตออกมาเป็น ตารางที่แน่นอน
...
แต่ละรายการในการตอบสนองจะให้ลิงก์ไปยังวิดีโอ เช่น
ถ้าคุณเมาส์มากกว่าครั้งแรกที่คุณได้:
...
และถ้าคุณคลิกบน html ตั้งค่าการแสดงผลวิดีโอของคุณ
บราวเซอร์
