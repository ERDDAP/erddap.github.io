...
Pokud nejste schopni najít otevřený problém řešení problému, [Otevři novou.](https://github.com/ERDDAP/erddap/issues/new) . Ujistěte se, že obsahuje název a jasný popis, co nejvíce relevantní informace, a pokyny pro reprodukci otázky nebo ERDDAP™ server demonstrující očekávané chování, které se neděje.
...
## Pro ERDDAP™ podpora admin serveru{#for-erddap-server-admin-support} 
