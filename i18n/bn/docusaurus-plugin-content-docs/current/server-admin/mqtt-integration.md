...
##  ERDDAP MQT ক্লায়েন্ট হিসাবে
 ...
 ERDDAP এটি এমকিউটিটি (এমকিউটি) ক্লায়েন্ট হিসেবে কাজ করতে পারে একটি বাইরের বিষয় বা তার নিজস্ব বিকল্প এমকিউটি ব্রোকার। এই নতুন পদ্ধতি ব্যবহার করে অর্জন করা যায় `EDDT টেবিল উৎসqt` ডাটা টাইপ ( ধরণের), যা বিদ্যমান ফাংশনের সাথে একইভাবে কাজ করে [ `EDD টেবিল Htttupet গেটComment` ](/docs/server-admin/datasets#eddtablefromhttpget) ডাটাসেট.
