...
# NC CSV-
একটিও নয় NetCDF - প্রবেশীয় ASCII CSV ফাইল,
সংস্করণ ১.১০
...
এই ডকুমেন্টটি একটি ASCII অক্ষরের বিন্যাসের যা সমস্ত তথ্য ধারণ করে (মিটা-ডাটা এবং তথ্য) যে একটি মধ্যে পাওয়া যাবে NetCDF   .nc অন্তর্ভুক্ত ফাইলটিতে একটি CSV-র ধরনের ফাইল আছে। ASCII CSV টেক্সট ফাইলের জন্য এই এক্সটেনশনটি ASCII অক্ষরের ফাইল। এই বৈশিষ্ট্যের সাহায্যে সহজে পড়া যাবে ও তখন মনে হয় যে, ASCII সংখ্যা এবং গুগল শিটের মত হতে পারে । বব সাইমন্স একজন NC CSV ফাইলকে একটি ফাইলে রূপান্তর করার সফটওয়্যার লিখতে হবে NetCDF -৩ (আর সম্ভবত NetCDF - ৪)   .nc কোনো তথ্য নেই। বব সাইমন্স পরিবর্তিত হয়েছে [ ERDDAP™ ](https://coastwatch.pfeg.noaa.gov/erddap/index.html) এই ধরনের ফাইল পড়তে ও লেখা সমর্থন করতে।
...
#####  uhhhh  {#uhhhh} 
    ...
    * এখন পর্যন্ত, #২৫৫ এর থেকে বেশী অক্ষর ব্যবহার নিরুৎসাহিত। এনসি সমর্থিতদের সমর্থন করে। ERDDAP™ অভ্যন্তরীণভাবে সমর্থন করে। কিছু আউটপুট ফাইল টাইপ সমর্থিত (জি, .json এবং .nccsv ) . . কিন্তু অনেক আউটপুট ফাইলের ধরন তাদের সমর্থন করে না । যেমন, NetCDF - ৩-ডি ফাইল সমর্থন করে না NetCDF বর্তমানে ব্যবহৃত ইউনিকোড অক্ষর ও সি-এফ-এর ক্ষেত্রে ১-ডি অক্ষরের ব্যবহার করা হয় না NetCDF স্ট্রিং (উদাহরণ, UTF-8) . . এটা সম্ভবত সময় মত উন্নত হবে।
         
#### অক্ষর{#char} 
