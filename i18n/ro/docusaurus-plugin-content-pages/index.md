...
---
## Ultima ERDDAP™ versiune{#latest-erddap-version} 

2, 30, 0 [documentația privind modificările](/changes#version-2300) şi [descarcă](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) .
...
seturile de date ştiinţifice grilate şi tabulare în formate de fişiere comune şi să facă grafice şi hărţi.
 ERDDAP™ este o sursă liberă și deschisă (Apaşi şi apaşi)   Java Servlet din NOAA   NMFS   SWFSC Divizia de cercetare în domeniul mediului ( ERD ) .
...
* Revizuiți conversațiile și puneți întrebări la [ https://groups.google.com/g/erddap ](https://groups.google.com/g/erddap) sau la [ https://github.com/erddap/erddap/discussions ](https://github.com/erddap/erddap/discussions) 
* Revizuirea și prezentarea de probleme [ https://github.com/erddap/erddap/issues ](https://github.com/erddap/erddap/issues) 
...
Există două moduri de a căuta mai multe ERDDAP™ s pentru seturi de date: [Caută mai multe ERDDAP™ s](/SearchMultipleERDDAPs.html) şi [ ERDDAP™ Descoperire date](http://erddap.com/) .


## Configuraţi - vă propriul ERDDAP™  {#set-up-your-own-erddap} 

 ERDDAP™ este o [Sursă liberă și deschisă](https://en.wikipedia.org/wiki/Free_and_open-source_software) Toate... Java   (servlet) , aplicație web care rulează într-un server de aplicații web (De exemplu, Tomcat (recomandată) , sau Jetty (funcţionează, dar noi nu-l sprijinim.) ) . Această pagină web este cea mai mare parte pentru oameni (" ERDDAP™ administratori") care vor să-şi însceneze propria afacere. ERDDAP™ instalarea pe propriul site web.

Pentru a începe cu o instalare citită [ghidul de instalare a implementarii](/docs/server-admin/deploy-install) .

### De ce să utilizaţi ERDDAP™ să-ţi distribui datele?{#why-use-erddap-to-distribute-your-data} 

Pentru că efortul mic de a configura ERDDAP™ aduce multe beneficii.

* Dacă aveți deja un serviciu web pentru distribuirea datelor dumneavoastră,
Puteți configura ERDDAP™ accesul la datele dvs. prin intermediul serviciului existent.
Sau, puteți configura ERDDAP™ pentru a accesa datele direct din fișierele locale.
* Pentru fiecare set de date, trebuie doar să scrie o mică bucată de XML pentru a spune ERDDAP™ modul de accesare a setului de date.
* Odată ce ai ERDDAP™ servind datele dvs., utilizatorii finali pot:
    ...
    * Construi alte lucruri utile și interesante pe partea de sus a ERDDAP Serviciile web -- vezi [ Awesome ERDDAP TM](https://github.com/IrishMarineInstitute/awesome-erddap) lista de minunat ERDDAP -proiecte conexe.

Poţi. [personalizează](/docs/server-admin/deploy-install#customize) dumneavoastră ERDDAP Aşa arată. ERDDAP™ reflectă organizația dumneavoastră și se potrivește cu restul site-ului.

## Este procedura de instalare greu? Pot s-o fac?{#is-the-installation-procedure-hard-can-i-do-it} 

Instalaţia iniţială durează ceva timp, dar nu este foarte greu. Poţi s-o faci. Dacă te blochezi, trimite-mi un e-mail la erd dot data at noaa dot gov . Te voi ajuta.
Sau, te poţi alătura [ ERDDAP™ Grup Google / Listă de corespondență](https://groups.google.com/g/erddap) şi pune-ţi întrebarea acolo.
...
*    [APDRC](https://apdrc.soest.hawaii.edu/erddap/index.html)   (Centrul de Cercetare a Datelor Asia-Pacific, Centrul Internaţional de Cercetare Pacific) la Universitatea din Hawaii (UH)  
...
*    [Canwin ERDDAP™ ](https://canwinerddap.ad.umanitoba.ca/erddap/index.html)   (Canadian Watershed Information Network) la Centrul pentru Știința Observarii Pământului (CEOS) , University of Manitoba
...
* CSIRO și OMI (Organizaţia de Cercetare Ştiinţifică şi Industrială a Comunităţii şi Sistemul Integrat de Observare a Marinei) 
...
*    [Servicii de Tehnologie High School](https://myhsts.org) , care oferă cursuri de codificare și tehnologie pentru studenți și adulți
*    [ICHEC](https://erddap.ichec.ie/erddap/index.html)   (Irish Centre for High-End Computing) 
*    [I NCO ESTE](https://erddap.incois.gov.in/erddap/index.html)   (Centrul Naţional Indian pentru Servicii de Informare Oceanică)  
...
*    [ NOAA CoastWatch Coasta de Vest](https://coastwatch.pfeg.noaa.gov/erddap/index.html) care este localizată și lucrează cu
...
*    [ NOAA IOOS NERACOOS](http://www.neracoos.org/erddap/index.html)   (Asociaţia Regională Nord-Est a Sistemelor de observare costieră şi oceanică)  
...
*    NOAA NGDC STP (Geofizică națională Centrul de Date, Solar -- Fizica Terestră) 
...
*    [ NOAA UAF](https://upwell.pfeg.noaa.gov/erddap/index.html)   (Cadrul de acces unificat)  
...
* Institutul Estuar San Francisco
...
* Universitatea Stanford, Gara Hopkins
*    [IODE UNESCO](https://erddap.oa.iode.org/erddap/index.html)   (Oceanografie internațională și informare Schimbul de date)  
...
Aceasta este o listă de doar unele dintre organizațiile în care ERDDAP™ a fost instalat de un individ sau de un anumit grup. Aceasta nu implică faptul că individul, grupul, sau organizația recomandă sau susține ERDDAP .
...
## Spectacol slide{#slide-shows} 

Iată câteva slide-uri PowerPoint și documente pe care Bob Simons le-a creat în legătură cu ERDDAP .

 **Conţinutul şi opiniile exprimate în aceste documente sunt opiniile personale ale lui Bob Simons şi nu reflectă în mod necesar nici o poziţie a Guvernului sau National Oceanic and Atmospheric Administration .** 

Cele patru documente principale:

*    [Principala introducere a ERDDAP™   (Versiunea 5) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/erddapTalk5.pptx) .
Şi tu poţi. [Uita-te la acest videoclip de Bob da această discuție![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=H541G1XXZrU&t=4) .
*    [O singură pagină de descriere a ERDDAP™   (.pdf) ](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/ERDDAP_OnePage.pdf) 
*    [ ERDDAP : Încărcături grele, grile, clustere, federații și cloud computing](/docs/server-admin/scaling) 
...
*    [2016 EDM: unu și făcut](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/OneAndDone.pptx) 
...
*    [2014 EDM: Interfața de utilizator ideală](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/TheIdealUserInterface.pptx) 
...
*    [Construirea propriei aplicații meteo folosind NOAA Deschideți date și notebook-uri Jupyter![YouTube](/img/youtube.png)](https://www.youtube.com/watch?v=MF-WH01Qw0g)   
...
Opt discuţii despre lucruri interesante pe care oamenii le fac ERDDAP de Jenn Sevadjian, Jim Potemra, Conor Delaney, Kevin O'Brien, John Kerfoot, Stephanie Petillo, Charles Carleton și Eli Hunter au prezentat pe 31 august 2017.
