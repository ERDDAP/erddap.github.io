...
2.30.0, देखें [दस्तावेज़ीकरण](/changes#version-2300) और [इसे डाउनलोड करें](https://github.com/ERDDAP/erddap/releases/tag/v2.30.0) ।
...
सामान्य फ़ाइल प्रारूपों में ग्रिड और सारणीबद्ध वैज्ञानिक डेटासेट और ग्राफ और मानचित्र बनाते हैं।
 ERDDAP™ एक मुक्त और खुला स्रोत है (अपाचे और अपाचे की तरह)   Java से सेवलेट NOAA   NMFS   SWFSC पर्यावरण अनुसंधान प्रभाग ( ERD ) ।
...
## अपना खुद का सेट करें ERDDAP™  {#set-up-your-own-erddap} 
 ...
 ERDDAP™ एक है [मुक्त और खुला स्रोत](https://en.wikipedia.org/wiki/Free_and_open-source_software) सभी Java   (जलाशय) वेब अनुप्रयोग सर्वर, जो वेब अनुप्रयोग सर्वर में चलता है (उदाहरण के लिए, टॉमकैट (अनुशंसित) जेटी (यह काम करता है, लेकिन हम इसे समर्थन नहीं देते) ) । यह वेब पेज ज्यादातर लोगों के लिए है (" ERDDAP™ व्यवस्थापक) जो अपने आप को स्थापित करना चाहते हैं ERDDAP™ अपनी वेबसाइट पर स्थापना।
...
* यदि आपके पास पहले से ही अपने डेटा को वितरित करने के लिए एक वेब सेवा है, तो आपके पास पहले से ही आपके डेटा को वितरित करने के लिए एक वेब सेवा है।
...
* एक बार जब तुम हो ERDDAP™ अपने डेटा की सेवा, अंत उपयोगकर्ता कर सकते हैं:
    ...
    * रेखाचित्र और मानचित्र बनाते हैं। (हर कोई सुंदर चित्र पसंद करता है।) 
...
आप कर सकते हैं [अनुकूलित](/docs/server-admin/deploy-install#customize) आपका ERDDAP इसलिए उपस्थिति ERDDAP™ अपने संगठन को दर्शाता है और आपकी वेबसाइट के बाकी हिस्सों में फिट बैठता है।

## क्या स्थापना प्रक्रिया कठिन है? क्या मैं इसे कर सकता हूँ?{#is-the-installation-procedure-hard-can-i-do-it} 

प्रारंभिक स्थापना कुछ समय लेती है, लेकिन यह बहुत मुश्किल नहीं है। आप ऐसा कर सकते हैं। यदि आप अटक जाते हैं, तो मुझे ईमेल करें erd dot data at noaa dot gov । मैं आपकी मदद करूँगा।
...
*    [एपीडीआरसी](https://apdrc.soest.hawaii.edu/erddap/index.html)   (एशिया-प्रशांत डेटा-अनुसंधान केंद्र, अंतर्राष्ट्रीय प्रशांत अनुसंधान केंद्र) हवाई विश्वविद्यालय में (यूएच)  
...
*    [डेवलपर ( NOAA ORR) ](https://pub-data.diver.orr.noaa.gov/erddap/index.html)   ( NOAA प्रतिक्रिया और बहाली का कार्यालय)  
...
*    [I NCO आईएस](https://erddap.incois.gov.in/erddap/index.html)   (महासागर सूचना सेवाओं के लिए भारतीय राष्ट्रीय केंद्र)  
* IRD (इंस्टीट्यूट्यूट डी रिचे डालो le Développement, फ्रांस)   
CNRS (सेंटर नेशनल डे ला रेचेरी वैज्ञानिक, फ्रांस)   
...
*    NOAA आईओएस (नेटवर्क महासागर अवलोकन प्रणाली के नॉर्थवेस्ट एसोसिएशन) 
...
*    [ NOAA IOS SECOORA](https://erddap.secoora.org/erddap/index.html)   (दक्षिणपूर्व तटीय महासागर क्षेत्रीय एसोसिएशन का अवलोकन)  
...
*    [ NOAA पीएमईएल](https://data.pmel.noaa.gov/pmel/erddap/index.html) 
...
*    [डेविस में कैलिफोर्निया विश्वविद्यालय, Bodega समुद्री प्रयोगशाला](http://bmlsc.ucdavis.edu:8080/erddap/index.html)  
...
###  ERDDAP™ भीतर की सिफारिश की जाती है NOAA सीएनएस{#erddap-is-recommended-within-noaa-and-cnrs} 
 [ NOAA डेटा एक्सेस प्रक्रियात्मक निर्देश](https://www.ngdc.noaa.gov/wiki/index.php/Data_Access_Technical_Recommendations#Software_implementations) शामिल ERDDAP™ समूहों के भीतर उपयोग के लिए अनुशंसित डेटा सर्वर की अपनी सूची में NOAA । ERDDAP™ विशेष रूप से अनुभाग 4.2.3 में उल्लेख किया गया है
[Guide de bonnes pratiques sur la gestion des données de la recherche
 (अनुसंधान डेटा प्रबंधन सर्वश्रेष्ठ अभ्यास गाइड) ] ( https://mi-gt-donnees.pages.math.unistra.fr/guide/04-traiter.html#deposer-et-structurer-dans-des-plateformes-de-gestion-de-donnees-locales ) सेंटर नेशनल डे ला रेचेरी वैज्ञानिक (CNRS) फ्रांस में।
...
*    [2019 IOS DMAC: नई सुविधाएँ ERDDAP™ v2.0](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/Erddapv2Features.pptx) 
...
*    [2017 EDM: डेटा स्रोत से अंत उपयोगकर्ता तक कैसे प्राप्त होता है? पुराने स्कूल बनाम न्यू स्कूल](https://coastwatch.pfeg.noaa.gov/erddap/images/erddapTalk/OldSchoolNewSchool.pptx) 
...
Filipe Fernandes और रिच Signell द्वारा SciPy 2018, 13 जुलाई 2018 को।
...
दिलचस्प चीज़ों के बारे में आठ पांच मिनट वार्ता लोग के साथ क्या कर रहे हैं ERDDAP जेन्न सेवाड्जियन, जिम पोटेमरा, कोनोर डेलनी, केविन ओ'ब्रायन, जॉन केरफुट, स्टेफ़नी पेटिलो, चार्ल्स कार्लटन और एली हंटर ने 31 अगस्त, 2017 को एक ESIP Tech Dive के रूप में प्रस्तुत किया।
...
*    [टेस्ट का प्रयोग ERDDAP™ ब्लू कार्बन डाटा![यूट्यूब](/img/youtube.png)](https://www.youtube.com/watch?v=TbOhElC_-qU)   
द्वारा रिच Signell, अगस्त 2015.
