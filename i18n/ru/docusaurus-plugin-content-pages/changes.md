...
*    **ВещиERDDAP™Администраторы должны знать и делать:** 
    ...
    * Новая функция для настройки информации, отображаемой о наборах данных в UI. Мы ожидаем, что это будет особенно полезно для добавления таких вещей, как цитаты из набора данных. Для более подробной информации вы можете прочитать[Новая документация](/docs/server-admin/display-info.md). Спасибо Аюшу Сингху за вклад&#33;
