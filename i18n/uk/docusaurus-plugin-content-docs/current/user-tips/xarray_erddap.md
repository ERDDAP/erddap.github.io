...
Про нас Python Пакет «xarray» дуже популярний для доступу, підкатування та візуалізації даних сітки в різних форматах. 'xarray' працює відмінно з ERDDAP™ Як правильно використовувати його. Я б сказав, що Python Пакет "erddapy" Р ( https://github.com/ioos/erddapy ) доступ до даних з ERDDAP™ сервери, які використовують як "griddap" і " tabledap ', і 'erddapy' може експортувати дані для 'xarray'. Але якщо ви звикли до використання 'xarray' і мають робочі процеси за допомогою пакета, то його можна бажано просто працювати в межах одного пакету. Нижче наведено приклад із даними «griddap».
