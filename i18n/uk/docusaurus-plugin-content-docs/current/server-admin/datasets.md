...
* Про нас ** &lt;cacheClearMinutes&gt; ** до (&lt;a href="http://realtor.if.ua/" title="Агентство нерухомості Ріелтор") рідко використовується тег OPTIONAL в межах&lt;erddapDatasets&gt; мітка вdatasets.xmlвказати частоту для перевірки кешованих файлів і видалення старих (хвилин)   (За замовчуванням=15) й Наприклад:
```
