...
Якщо ви не змогли знайти питання, що стосуються проблеми, [відкрити новий](https://github.com/ERDDAP/erddap/issues/new) й Обов'язково вкажіть назву і чіткий опис, якомога більше відповідної інформації, і напрямки для відтворення питання або ERDDAP™ сервер, що показує очікувану поведінку, яка не відбувається.
...
## Для ERDDAP™ Статус на сервери{#for-erddap-server-admin-support} 
