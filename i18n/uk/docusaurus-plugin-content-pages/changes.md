...
*    **РедакціяERDDAP™Адміністратори повинні знати і зробити:** 
    ...
    * Нова функція для налаштування інформації, що відображається про дані в UI. Ми очікуємо, що це може бути особливо корисним, щоб додати речі, такі як цитування даних. Для отримання більш детальної інформації Ви можете прочитати[Нова документація](/docs/server-admin/display-info.md)й Дякуємо Ayush Singh за внесок&#33;
