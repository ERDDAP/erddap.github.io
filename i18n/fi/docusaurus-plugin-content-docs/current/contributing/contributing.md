...
Jos et löydä avointa ongelmaa, [Avaa uusi](https://github.com/ERDDAP/erddap/issues/new) . Muista sisällyttää otsikko ja selkeä kuvaus, niin paljon asiaankuuluvaa tietoa kuin mahdollista, ja ohjeet ongelman tai ERDDAP™ Palvelin osoittaa odotetun käyttäytymisen, jota ei tapahdu.
...
## For For ERDDAP™ Palvelimen tuki{#for-erddap-server-admin-support} 
