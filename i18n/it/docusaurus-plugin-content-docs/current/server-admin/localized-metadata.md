...
2.  **Comportamento predefinito** :
   - Se non vengono forniti tag xml:lang, le informazioni fornite verranno visualizzate per tutte le lingue. Questo corrisponde al comportamento precedente.
