...
*    **ΠράγματαERDDAP™Οι διαχειριστές πρέπει να γνωρίζουν και να κάνουν:** 
    ...
    * Νέο χαρακτηριστικό για την προσαρμογή των πληροφοριών που εμφανίζονται σχετικά με τα σύνολα δεδομένων στο UI. Αναμένουμε ότι αυτό θα είναι ιδιαίτερα χρήσιμο για να προσθέσουμε πράγματα όπως αναφορές σε σύνολα δεδομένων. Για περισσότερες λεπτομέρειες μπορείτε να διαβάσετε το[νέα τεκμηρίωση](/docs/server-admin/display-info.md). Χάρη στον Ayush Singh για τη συνεισφορά&#33;
