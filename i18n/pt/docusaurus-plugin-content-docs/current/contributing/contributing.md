...
Se você não conseguir encontrar um problema aberto abordando o problema, [abrir um novo](https://github.com/ERDDAP/erddap/issues/new) . Certifique-se de incluir um título e uma descrição clara, tanto informações relevantes quanto possível, e direções para reproduzir o problema ou um ERDDAP™ servidor demonstrando o comportamento esperado que não está ocorrendo.
...
## Para ERDDAP™ suporte de administrador do servidor{#for-erddap-server-admin-support} 
