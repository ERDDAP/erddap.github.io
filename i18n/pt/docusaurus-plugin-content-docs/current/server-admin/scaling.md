...
Algumas razões diretas por que você não pode / não deve configurar vários idênticosERDDAPs são:
...
Se alguém quiser trabalhar nisto, por favor contacteerd.data at noaa.gov.
