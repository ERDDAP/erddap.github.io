...
Der Technische Vorstand ist für folgende Dokumente und Prozesse verantwortlich:
...
* Wenn eine Sitzung des Technischen Ausschusses erforderlich ist, sollten Notizen veröffentlicht werden.

* Die Sitzungen des Technischen Boards sind allen interessierten Parteien offen, aber der Board sucht nur nach Konsens zwischen den Vorstandsmitgliedern und Vertretern des Teams, das den Vorschlag vorgelegt hat.

* Nominierungen für den Technischen Vorstand werden in regelmäßigen SIG-Meetings jedes Quartal berücksichtigt. Chris John, als NATD, ist verantwortlich für die Nominierung von Kandidaten, und eine Abstimmung der SIG wird durchgeführt, um die endgültige Mitgliedschaft auszuwählen, oder Veto. Die Ernennung erfolgt für einen Zeitraum von zwei Jahren.

## Sitzungsvorsitzender{#meeting-chair-duties} 

- Überprüfung der Agenda für dieses Treffen.

- Erleichterung des Treffens

  - Rund um die nötigen Personen für das Treffen

  - Aktionen von letztem Treffen überprüfen

  - Folgen Sie der Agenda

- Schreiben Sie Minuten für das Treffen.

  - Post Minuten zu einer Diskussion über GitHub.

    - Betrifft: Protokoll der Sitzung des Technischen Ausschusses, YYYY-MM-DD

    - Abschnitt: Teilnehmer, Anmerkungen

- Update Agenda für das nächste Treffen.

- Wenn nötig eskalieren Sie alle Probleme an der SIG.
