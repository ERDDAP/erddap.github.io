...
Der Grund, warum dies einen Fehler verursacht, ist, dass 'xarray' verwendet wird OPeNDAP   ( https://www.opendap.org ) als Protokoll für den Fernzugriff und ERDDAP™ syntax basiert auf OPeNDAP Syntax und ERDDAP™ Server kann auch als OPeNDAP Server, es gibt Unterschiede, wie dies für die beiden Dienste getan wird. (Siehe zum Beispiel https://coastwatch.pfeg.noaa.gov/erddap/griddap/documentation.html#opendapLibraries ) .
