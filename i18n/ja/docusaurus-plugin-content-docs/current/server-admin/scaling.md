...
rsyncが何をしているか、データセットのレプリケーションに向いているプログラムがいくつかあります。 (多くの場合、ファイルコピーレベルで) 、例えば、Unidataお問い合わせ[ダイヤルイン](https://www.unidata.ucar.edu/projects/index.html#idd)お問い合わせ
